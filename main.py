...
async def summarize(request: SummarizeRequest):
    ...
    Handles long texts by summarizing in chunks then combining.
    """
    try:
        text = request.text.strip()
        ...
        # For long texts, split and summarize each chunk, then combine
        ...
        if len(chunks) == 1:
            ...
            # Long text: summarize each chunk first
            partial_summaries = []
